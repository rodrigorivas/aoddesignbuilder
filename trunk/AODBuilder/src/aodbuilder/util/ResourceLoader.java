...
{  
    ...
    private ResourceLoader () {} // this class is not extentible
    ...
    public static Properties loadProperties (final String name)
    {
	     ...
	     * THROW_ON_LOAD_FAILURE is true
	     */
	    public static URL getResourceURL (String name, ClassLoader loader)
	    {
	        ...
	        if (THROW_ON_LOAD_FAILURE && (url == null))
	        {
	            throw new IllegalArgumentException ("could not load [" + name + "]" +
	                " as " + (LOAD_AS_RESOURCE_BUNDLE
	                ? "a resource bundle"
	...
	/**
	 *  Return URL of the given resource name using current thread context loader
	 */
    ...
    public static void main(String[] args) {
		System.out.println(ResourceLoader.getResourceURL("englishPCFG.ser.gz").getFile());
	}
